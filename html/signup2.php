...
if($tryagain=="true")
{
   ...
   echo "<a class="."'download-button btn btn-lg btn-dark'"." href="."'signup2.html'"." type="."'link'".">Sign Up Again</a>";
...
echo "<h1></br></br></br>Successfully Registered!!</br></br><h1>";
 echo "<a class="."'download-button btn btn-lg btn-dark'"." href="."'search_to_login.php'"." type="."'link'".">Return to Login</a>";
